...
<head>
  ...
  <style type="text/css">
    /* Outlook-safe styles */
    table, tr, td, a, span {{ font-family: Aptos, Arial, Helvetica, sans-serif !important; }}
...
<body style="margin: 0; padding: 0;">
    ...
    <tr>
      <td style="padding: 0 0 12px 0;">
        <table role="presentation" border="0" cellspacing="0" cellpadding="0" width="500" style="width: 500px;">
          <tr>
            <td valign="middle" width="128" style="width: 128px; padding-right: 8px; border-right: 2px solid #312d2d;">
              <!--[if mso]>
                ...
                <tr>
                  <td style="padding: 4px 0;">
                    <div style="margin: 0; padding: 0; line-height: 1.2;">
                      <span style="font-size: 11pt; font-weight: bold; color: #006400; font-family: Aptos, Arial, Helvetica, sans-serif;">{name} | </span><span style="font-size: 11pt; color: #000; font-family: Aptos, Arial, Helvetica, sans-serif;">{title}</span>
                    </div>
                    <div style="margin: 2px 0 0 0; padding: 0; line-height: 1.2;">
                      <span style="font-size: 10pt; font-weight: bold; color: #000; font-family: Aptos, Arial, Helvetica, sans-serif;">CONSOLIDATED MOSQUITO ABATEMENT DISTRICT</span>
                    </div>
                  </td>
                </tr>
                <tr>
                  <td style="padding-top: 8px;">
                    <table role="presentation" cellspacing="0" cellpadding="2" border="0">
                      <tr>
                        ...
                        <td><a href="tel:{cleaned_phone}" style="text-decoration: none; color: #000;"><span style="font-size: 9pt; color: #000; font-weight: bold; font-family: Aptos, Arial, Helvetica, sans-serif;">{phone}</span></a></td>
                      </tr>
                      <tr>
                        ...
                        <td width="4" style="width: 4px;">&nbsp;</td>
                        <td><a href="mailto:{email}" style="text-decoration: none; color: #000;"><span style="font-size: 9pt; color: #000; font-weight: bold; font-family: Aptos, Arial, Helvetica, sans-serif;">{email}</span></a></td>
                      </tr>
                      <tr>
                        ...
                        <td width="4" style="width: 4px;">&nbsp;</td>
                        <td><a href="{linkedin}" target="_blank" style="text-decoration: none; color: #000;"><span style="font-size: 9pt; color: #000; font-weight: bold; font-family: Aptos, Arial, Helvetica, sans-serif;">LinkedIn</span></a></td>
                      </tr>
                    </table>
                  </td>
                </tr>
            ...
            <td valign="middle" width="124" style="width: 124px; padding-left: 8px;">
  ...
  <table role="presentation" width="500" cellpadding="0" cellspacing="0" border="0" style="width: 500px; background-color: #312d2d;">
    <tr>
      <td align="center" style="padding: 8px 0 6px 0;">
        <span style="font-size: 14pt; font-weight: bold; color: #ffffff; font-family: Aptos, Arial, Helvetica, sans-serif;">Follow Our Updates</span>
      </td>
    </tr>
    <tr>
  ...
  <table role="presentation" width="500" cellpadding="0" cellspacing="0" border="0" style="width: 500px;">
    <tr>
      <td style="padding: 10px 0 0 0; font-size: 8pt; color: #737373; line-height: 1.3; font-family: Aptos, Arial, Helvetica, sans-serif;">
